...
public class Script_Instance : GH_ScriptInstance
{
    ...
    // ............................................................ global variables 
    public GH_Plane[] gP;  // contains planes for geometry output

    public AgentPlaneSystem aPS; // agent planes system

    //        __ static means that the global variable can also be accessed from the classes methods
    //       /
    public static TensorPoint[] TensorField; // field of tensor points - contains scalar and vector data
    public static Mesh MEnvironment; // Mesh used as environment for agents (for position only)
    public static RTree MeshRTree; // RTree for fast Mesh search
    public int iterationsCount; // for iterations count
    ...
    public class AgentPlaneSystem
    {
        ...
        public void Update()
        {
            ...
            // . . . . . . . . . . custom behavior(s) DBD2020
            // CustomBehavior(); // uncomment this line to call agent custom behavior
    ...
    public class AgentPlane
    {
        ...
        public AgentPlaneSystem agentSim;
        ...
        // CUSTOM AGENT BEHAVIOR DBD2020
        public void CustomAgentBehaviour()
        {
            // . . . . . . . insert your custom agent behavior here
        ...
        {
            desiredDirection += fieldVector * agentSim.FieldStrength;
        }
        ...
        public void SeekColor()
        {
            ...
            if (neighTens.Count > 0)
            {
                ...
                if (MaxBri < 0.2) // move away from extra-dark areas - if you modify this value remember 0.2 was the default
                {
    ...
    /// <summary>
    /// This function converts a -1 to 1 Vector3d into a 0-255 RGB color
    /// </summary>
    /// <param name="v"></param>
    /// <returns>GH_Colour in 0-255 range</returns>
